...
Returning the array of adjusted sub-population rates may be desired for those looking to calculate *category effects* as detailed in [Chevan & Sutherland 2009](https://doi.org/10.1353/dem.0.0060){target="_blank"} to examine the amount to which a difference in rates is attributable to differences in _specific_ sub-populations (see [associated vignette](TODO){target=_blank}). 
